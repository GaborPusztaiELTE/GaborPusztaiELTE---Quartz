...
8. Frissítsük a dns adatainkat!
    - ipconfig /flushdns
9. Nyissuk meg a következő oldalt: [http://oktnb147.inf.elte.hu/ggombos/upload/](http://oktnb147.inf.elte.hu/ggombos/upload/)
10. Töltsük fel a letöltött filet.
11. Nyissuk meg a [tanrend.elte.hu](https://tanrend.elte.hu/)-t!
12. Állítsuk meg a felvételt wiresharkban!
...
7. Vannak-e benne ARP kérések? 
    1. Hány kérés ment egy adott IP-re? (arp.dst.proto_ipv4)
